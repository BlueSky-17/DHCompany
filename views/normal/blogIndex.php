        ...
        <div class="col-lg-8 entries">
                  ...
                  <article class="entry">
                    ...
                    <div class="entry-content">
                      ...
                      <div class="read-more">
                        ...
                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal-' . $news->id . '" id=more' . $news->id . '>
                          Đọc thêm
                        </button>
                      </div>
                    </div>
          ...
          <div class="blog-pagination">
            <ul class="justify-content-center">
              <li><a href="index.php?user=normal&controller=blog&action=index&pg=1">1</a></li>
              <li><a href="index.php?user=normal&controller=blog&action=index&pg=2">2</a></li>
              <li><a href="index.php?user=normal&controller=blog&action=index&pg=3">3</a></li>
            </ul>
          </div>
